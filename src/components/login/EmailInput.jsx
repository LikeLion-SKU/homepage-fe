      ...
      <div className="flex flex-row items-center gap-2 sm:gap-4">
        <div className="flex items-center gap-1.5 sm:gap-4 flex-1 min-w-0">
          <input
            ...
            disabled={disabled}
            className={`w-full sm:max-w-[280px] h-12 sm:h-14 max-[380px]:h-10 px-3 sm:px-4 max-[380px]:px-2.5 py-2.5 sm:py-3 max-[380px]:py-2 bg-[#FFFFFF] border border-[1px] border-[#B0B0B0] ${textColor} text-sm sm:text-base max-[380px]:text-xs text-left font-['Pretendard'] focus:outline-none focus:ring-2]`}
            style={{ minWidth: 0 }}
          />
