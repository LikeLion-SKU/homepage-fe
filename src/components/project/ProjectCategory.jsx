...
export default function ProjectCategory({ award, semester, projectTypeName }) {
  return (
    <div className="flex gap-1 items-center">
      ...
      <div
        className="flex border rounded-3xl h-3.5 pad:h-4.5 web:h-5 py-1.75 pad:py-0 px-2 leading-0
      text-[0.6rem] web:text-[0.9rem] text-center items-center bg-white"
      >
        {semester}기
      </div>
      <div
        className="flex border rounded-3xl h-3.5 pad:h-4.5 web:h-5 px-2 py-1.75 leading-0
      text-[0.6rem] web:text-[0.9rem] text-center items-center bg-white"
      >
        {projectTypeName}
      </div>
