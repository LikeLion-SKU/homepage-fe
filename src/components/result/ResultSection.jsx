...
export default function ResultSection({ pass }) {
  const documentPass = `안녕하세요. IT 동아리 멋쟁이사자처럼 서경대학교 ${pass.semester}기입니다.
${pass.track} 트랙 1차 서류 전형 합격을 진심으로 축하드립니다. 많은 분들께서 지원해 주신 만큼, 
...
감사합니다.`;
  const documentNotPass = `안녕하세요. IT 동아리 멋쟁이사자처럼 서경대학교 ${pass.semester}기입니다.
${pass.track} 트랙에 지원해 주셔서 진심으로 감사드립니다. 지원자님의 서류는 운영진 모두가 끝까지 신중하게 검토하였으며,
...
곧 만나 뵙기를 기대하겠습니다. 감사합니다.`;
  const interviewNotPass = `안녕하세요. IT 동아리 멋쟁이사자처럼 서경대학교 ${pass.semester}기입니다.
${pass.track} 트랙 면접 전형에 참여해 주셔서 진심으로 감사드립니다. 면접 과정에서 지원자님께서 보여주신 고민과 경험, 
