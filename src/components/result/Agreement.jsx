...
export default function Agreement({ setAllChecked, hide }) {
  ...
  수료 조건 미충족 시 회비는 돌려드리지 않습니다.`;
  const contents = `트랙별 주 1회 18시30분~20시30분 세션 필수 참여
  
  3월 16일(월) 18시 - 교내 OT 및 회식 필수 참여
  3월 18일(수) 18시 시간 미정 - 중앙 OT 참여 권고(비대면)
  5월 중 진행 되는 중앙아이디어톤 필수 참여
  5월 중순에 진행되는 아기사자 전체 MT 필수 참여
  7~8월 한 달간 진행되는 중앙해커톤 필수 참여
  11월 말에 진행 되는 타학교 연합해커톤(4호선톤) 필수 참여 
