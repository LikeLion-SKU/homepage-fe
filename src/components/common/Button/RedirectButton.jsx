...
export default function RedirectButton({ buttonName, onClick }) {
  return (
    <div
      ...
      role="button"
    >
      <div className="w-10 h-10 pad:w-12 pad:h-12 bg-button-green hover:bg-button-hover outline flex flex-col justify-center items-center gap-2.5">
        <img src={Navy} className="w-4 h-4 pad:w-6 pad:h-5" alt="navy icon" />
      </div>
      <div className="self-stretch h-10 pad:h-12 px-4 py-3 outline bg-button-gray hover:bg-stone-200 relative z-10 flex items-center justify-center transition-all">
